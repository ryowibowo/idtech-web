@section('title', env('APP_NAME') .' | Kebijakan Privasi')
...
<div class="content-wrap about-wrap margin-tb50">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h1 class="color-primary">Kebijakan Privasi</h1>
                @if(count(array($privacy)) == 0)
                <center>
                ...
                @else
                    @foreach($privacy as $data_privacy)
                        <div><?php echo $data_privacy['value'];?>
                    @endforeach
                @endif
            </div>
    </div>
