...
class AboutUsController extends Controller {
    ...
    public function index() {
        ...
        return view('aboutus::index', $api->data);
        
    }

    public function download() {
        $file= public_path(). "/assets/img/about.pdf";
        return response()->download($file);  

        $api = new ApiCLient();
        $api->getAboutUs();

        $pdf = PDF::loadView('aboutus::download', $api->data)->setPaper('a4'); 
        
        // return $pdf->download('About_Idtech.pdf');
        return view('aboutus::download', $api->data);
    }
