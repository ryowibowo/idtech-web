@section('title', env('APP_NAME') .' | Cari Produk')
    ...
    <section>
        <div class="container">
            <div class="form-inline section-text">
                <a href="#"><strong class="">Hasil pencarian produk {{$cari}} </strong></a>
...
<!--                                    <form class="form-btn-chat" action="#" method="post" style="padding-bottom: 5px;">
                            ...
                            @if($data_product['product_image'] == '' || $data_product['product_image'] == null || config('app.just_url_api') == $data_product['product_image'])
                                @if($data_product['product_stock'] == "0" || $data_product['product_stock'] == 0)
                                    <img class="img-thumbnail card-img-top smallimg" style="height: 200px;opacity:0.5" src="<?php echo URL::to('/'); ?>/assets/img/no-image.png" alt="">
                                @else
                                    <img class="img-thumbnail card-img-top smallimg" style="height: 200px;" src="<?php echo URL::to('/'); ?>/assets/img/no-image.png" alt="">
                                @endif
                            @else
                                @if($data_product['product_stock'] == "0" || $data_product['product_stock'] == 0)
                                    <img class="img-thumbnail card-img-top smallimg" style="height: 200px;" src="{{$data_product['product_image']}}" alt="" style="opacity:0.5">
                                @else
                                    <img class="img-thumbnail card-img-top smallimg" style="height: 200px;" src="{{$data_product['product_image']}}" alt="">
                                @endif
                            @endif
                        </div>
                    ...
                    <div class="container no-padding">
                        <div class="btn-group-toggle">
                            <div class="varian-wrap">
                                <div class="container">
                                    <form  action="{{url('product/searching')}}" id="formSorting" role="form" method="post" action="" class="form-style" enctype="multipart/form-data">
                                        @csrf
                                        <div class="row">
                                            <input class="form-control" name="product_name" type="hidden" value="{{ $product_search }}">
                                        ...
                                        <div class="modal-footer">
                                            <div class="row">
                                                <div class="col-sm-12 no-padding-left no-padding-right">
                                                    <div>
                                                        <button type="submit" class="btn btn-secondary btn-block" style="width: 100%;"> <i class="fa fa-check" style="color: black;" id="btnSorting"></i> Submit </button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
